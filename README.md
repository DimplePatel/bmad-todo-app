...
npm run test:backend         # Vitest + Supertest — 47 cases
...
| [`docs/test-strategy.md`](docs/test-strategy.md) | QA output — pyramid, tooling, **§11 per-test → PRD requirement traceability (112 mappings)** |
...
-------------------------- ------- ------- -----------------------------------------
Backend unit                  3      23     config, schema, repository
Backend integration           3      24     health (+ notFoundHandler), todos, persistence
